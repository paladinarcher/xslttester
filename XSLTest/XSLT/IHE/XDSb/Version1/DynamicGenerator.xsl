...
<!-- 
Custom version of "SDA-to-Document.xsl" used for dynamic CCD generation 
* Does not generate document key, and thus does not update submission table
* Sets the status to Deprecated
-->
...
<AvailabilityStatus>Deprecated</AvailabilityStatus>
