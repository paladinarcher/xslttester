		...
		<QUPA_IN101103 xmlns:hl7="urn:hl7-org:v3"
			...
			<controlActProcess moodCode="EVN">
				...
				<authorOrPerformer typeCode="AUT">
					<assignedPerson>
						<id root="2.16.840.1.999999.1.2" extension="{RequestingUser}"/>
						<code codeSystem="2.16.840.1.999999.1" code="{RequestingUserRoles}"/>
				...
				<queryByParameter>
					...
					<queryByParameterPayload>				
						...
						<person.administrativeGender>
							<value codeSystem="2.16.840.1.113883.5.1" code="{Sex}"/>
						</person.administrativeGender>
						<person.birthTime>
							<value value="{DOB}"/>
						</person.birthTime>
