...
<xsl:template match="/">
	<xsl:element name="{$sectionName}">
		<xsl:apply-templates select="/Container/Patients/Patient/Encounters/Encounter/Problems/Problem">
...
<xsl:template match="/Container/Patients/Patient/Encounters/Encounter/Problems/Problem">
