		...
		<ClinicalDocument xmlns="urn:hl7-org:v3" xmlns:sdtc="urn:hl7-org:sdtc">
			...
			<component>
				<structuredBody>
					...
					<xsl:apply-templates select="Patient" mode="reasonForReferral"/>
					...
					<xsl:apply-templates select="Patient" mode="familyHistory"/>
					
					<!-- Social History module -->
					<xsl:apply-templates select="Patient" mode="socialHistory"/>
