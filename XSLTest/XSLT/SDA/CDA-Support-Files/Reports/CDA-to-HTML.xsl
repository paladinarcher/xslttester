<?xml version="1.0"?>
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:n1="urn:hl7-org:v3" xmlns:n2="urn:hl7-org:v3/meta/voc" xmlns:n3="http://www.w3.org/1999/xhtml" xmlns:voc="urn:hl7-org:v3/voc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
	...
	<xsl:template match="n1:content[contains(@ID,'result') or contains(@ID,'Result') or contains(@ID,'RESULT')]">
		<xsl:choose>
	...
	<xsl:template match="n1:td[contains(@ID,'result') or contains(@ID,'Result') or contains(@ID,'RESULT')]">
		<td>
		<xsl:choose>
			<xsl:when test="contains(text(),'&#10;')">
				<pre><xsl:apply-templates/></pre>
	...
	<xsl:template match="n1:renderMultiMedia">
		...
		<xsl:choose>
			<xsl:when test="//n1:regionOfInterest[@ID=$imageRef]"><!-- Here is where the Region of Interest image referencing goes -->
			...
			<xsl:otherwise><!-- Here is where the direct MultiMedia image referencing goes -->
