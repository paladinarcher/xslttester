	...
	<xsl:template match="*" mode="VitalSignDetail">
		...
		<Observation>
			...
			<!--
				...
				Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.1.5.3.2']/entry/organizer/author
			...
			<!--
				...
				Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.1.5.3.2']/entry/organizer/informant
			...
			<!--
				...
				Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.1.5.3.2']/entry/organizer/author/time/@value
			-->
