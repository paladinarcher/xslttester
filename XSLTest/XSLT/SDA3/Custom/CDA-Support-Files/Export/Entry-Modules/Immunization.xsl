...
<xsl:stylesheet version="1.0" xmlns="urn:hl7-org:v3" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:sdtc="urn:hl7-org:sdtc" xmlns:isc="http://extension-functions.intersystems.com" xmlns:exsl="http://exslt.org/common" xmlns:set="http://exslt.org/sets" exclude-result-prefixes="isc xsi sdtc exsl set">
	...
	<xsl:template match="*" mode="immunizations-NarrativeDetail">
		...
		<tr ID="{concat($exportConfiguration/immunizations/narrativeLinkPrefixes/immunizationNarrative/text(), $narrativeLinkSuffix)}">
			<td ID="{concat('indImmunization-', position())}"><xsl:apply-templates select="OrderItem" mode="originalTextOrDescriptionOrCode"/></td>
			 <td ID="{concat('indSeries-', position())}"><xsl:apply-templates select="Administrations/Administration/AdministrationStatus/Description/text()" mode="immunization-seriesNumber"/></td>
			<!-- To do: find how to get Series data.  <td ID="{concat($exportConfiguration/immunizations/narrativeLinkPrefixes/immunizationFilledName/text(), $narrativeLinkSuffix)}"><xsl:apply-templates select="DrugProduct" mode="originalTextOrDescriptionOrCode"/></td>-->
			<td ID="{concat('indDateIssued-', position())}">
				<xsl:choose>
			...
			<td ID="{concat('indReaction-', position())}"><xsl:value-of select="Extension/Reaction/Description/text()"/></td>
			<td ID="{concat('indComments-', position())}"><xsl:value-of select="Comments/text()"/></td>
		</tr>
	</xsl:template>
		...
		<entryRelationship typeCode="SUBJ">
			<observation classCode="OBS" moodCode="EVN">
				...
				<!--
					...
					Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.23']/entry/substanceAdministration/entryRelationship/observation[code/@code='30973-2']/value/@value
