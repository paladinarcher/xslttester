...
<xsl:stylesheet version="1.0" xmlns="urn:hl7-org:v3" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:sdtc="urn:hl7-org:sdtc" xmlns:isc="http://extension-functions.intersystems.com" xmlns:exsl="http://exslt.org/common" xmlns:set="http://exslt.org/sets" exclude-result-prefixes="isc xsi sdtc exsl set">
	...
	<xsl:template match="*" mode="allergies-NarrativeDetail">
		...
		<tr>
			...
			<!-- Verification Date -->
			<td><xsl:value-of select="VerifiedTime"/></td>			

			<!-- Event Type -->
			<td><xsl:value-of select="AllergyCategory/Description/text()"/></td>
			...
			<!-- Severity -->
			<td ID="{concat($exportConfiguration/allergies/narrativeLinkPrefixes/allergySeverity/Description/text(), position())}"><xsl:value-of select="Severity/Description"/></td>
			
			<!-- Source -->
			<td ID="{concat('allergySource-', position())}"><xsl:value-of select="EnteredAt/Description/text()"/></td>

			<!-- <td ID="{concat('andCodedAllergyName-', position())}"><xsl:value-of select="Allergy/Code"/></td>
			<td ID="{concat('andVerificationDate-', position())}">><xsl:apply-templates select="FromTime" mode="narrativeDateFromODBC"/></td>
			...
			<td ID="{concat('allerguSource-', position())}"><xsl:value-of select="EnteredAt/Description/text()"/></td>
