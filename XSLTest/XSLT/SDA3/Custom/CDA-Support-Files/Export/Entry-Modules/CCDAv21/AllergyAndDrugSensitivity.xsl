  ...
  <!-- AlsoInclude: AuthorParticipation.xsl Comment.xsl -->
		...
		<text>
			...
			<!-- VA Allergies/Drug Business Rules for Medical Content -->
         	<paragraph>
				...
				The data comes from all VA treatment facilities. It does not list Allergies/ADRs that were 
				removed or entered in error. Some allergies/ADRs may be reported in the Immunization section. 
         	</paragraph>
	...
	<xsl:template match="Allergy" mode="eADS-allergies-NarrativeDetail">
		...
		<tr ID="{concat($exportConfiguration/allergies/narrativeLinkPrefixes/allergyNarrative/text(), position())}">
			<td ID="{concat($exportConfiguration/allergies/narrativeLinkPrefixes/allergyAllergen/text(), position())}"><xsl:value-of select="FreeTextAllergy/text()"/></td>
			<td><xsl:apply-templates select="EnteredOn" mode="formatDateTime"/></td>
			...
			<td ID="{concat($exportConfiguration/allergies/narrativeLinkPrefixes/allergyReaction/text(), $allergyNumber)}"><xsl:value-of select="Extension/Reactions/Reaction/Description/text()"/></td>
			...
			<td ID="{concat('allergySource-', position())}"><xsl:value-of select="EnteredAt/Description/text()"/></td>
		</tr>
