			...
			<paragraph ID="vitalsParagraph">
				<xsl:choose>
                	<xsl:when test="$flavor = 'MHV'">
                		The included list of inpatient and outpatient Vital Signs is from the last 12 months and 
                		includes a maximum of the 5 most recent sets of vital sign values. If more than one set of 
                		vitals were taken on the same date, only the most recent set is populated for that date. 
                	...
                	<xsl:otherwise>
                		...
                		the requested date range. If more than one set of vitals was taken on the same date, only 
                		the most recent set is populated for that date. If no date range was provided, it includes 
                		12 months of data, with a maximum of the 5 most recent sets of vitals. If more than one set 
                		of vitals was taken on the same date, only the most recent set is populated for that date. 
   					</xsl:otherwise>
            	</xsl:choose>
           	</paragraph>
